...
/**
 *	Exact comparison operator for equality test ("==")
 * @author gl17
 * @date 01/01/2018
 */
public class Equals extends AbstractOpExactCmp {
    ...
    /**
     *  Generate code for an Equals expression in a declaration for example, in a main program.
     *
    ...
    protected void codeGenExpr(DecacCompiler compiler, boolean init){
      ...
      compiler.addInstruction(new BNE(loadFalse));
    ...
    /**
     *  Generate code for an Equals expression in a declaration for example, in a method.
     *
     * @param compiler  (contains the "env_types" attribute)
     *
     * @param init is used to know if we are in an initialization case.
    ...
    /**
     *  Generate code for a comparison that has an Equals in his expression.
